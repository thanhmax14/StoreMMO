...
namespace StoreMMO.Web.Pages.Seller
{
	...
	public class UpdateStoreDetailModel : PageModel
    {
        ...
        public UpdateStoreDetailModel(IStoreService storeService, AppDbContext context, IProductService productService)
        {
        ...
        public IActionResult OnGet(string storeDetailId)
        {
            ...
            // Gán dữ liệu vào input để hiển thị sẵn thông tin khi vào trang
        ...
        public IActionResult OnPost()
        {
            ...
            try
            {
             ...
             //   var storedetails = new StoreDetail();
                storedetails.Name = input.Name.Trim();
                storedetails.SubDescription = input.SubDescription.Trim();
                storedetails.DescriptionDetail = input.DescriptionDetail.Trim();
